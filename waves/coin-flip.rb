...
let RATEMULT = 10000
let RATE  = 19000 # 1.9000 x RATE_MULT
...
func validateBetAndGetWinAmount(bet: Int, internalAssetIdx: Int, playerChoice: String) = {
    ...
    if dicesCount != 1 then throw("Invalid length of player's choice") else
...
func generateRandChoise(gameId: String, rsaSign: ByteVector) = {
    ...
    let rand = toInt(sha256(rsaSign)) % 2
